...
//                 <br>
//                 </br>
//                 <Link to="/Home"><button OnClick ={handleChange} class="sign-btn" >Login</button></Link>
      ...
      <div className="box">
        <div className="inner-box">
          ...
          <div className="carousel">
            <img className="wall" style={{ height: "500px" }} src="https://www.algopage.com/wp-content/themes/algopage/images/growth-img.gif" alt="Bank Reception" />
          </div>
        </div>
      </div>
    </div>
